...
So, this is that, except for Epitech students.

## Adding your site

To add your site, you **must** be a current student or alumni of Epitech.

Then, do the following.

1. Click on add your profile button
2. Enter your info
3. You are now a member of teknetwork

Your (current or former) Epitech enrollment will be verified upon submission!
...
Thanks to the original authors (@simcard0000, @janakitti) for the inspiration.
